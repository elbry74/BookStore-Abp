    ...
    IStringLocalizer<OpenIddictResponse> l)
{
    ...
    _openIddictApplicationRepository = openIddictApplicationRepository ?? throw new ArgumentNullException(nameof(openIddictApplicationRepository));
    _applicationManager = applicationManager ?? throw new ArgumentNullException(nameof(applicationManager));
    _openIddictScopeRepository = openIddictScopeRepository ?? throw new ArgumentNullException(nameof(openIddictScopeRepository));
    _scopeManager = scopeManager ?? throw new ArgumentNullException(nameof(scopeManager));
    _permissionDataSeeder = permissionDataSeeder ?? throw new ArgumentNullException(nameof(permissionDataSeeder));
    L = l ?? throw new ArgumentNullException(nameof(l));
}
